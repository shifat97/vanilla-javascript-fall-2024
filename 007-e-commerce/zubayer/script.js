...
const getIncreaseQuantityBtn = (cartItem) => {
  ...
  increaseQuantityBtn.className = 'text-green-500 ml-2';
...
const getDecreaseQuantityBtn = (cartItem) => {
  ...
  decreaseQuantityBtn.className = 'text-yellow-500 ml-2';
...
const getCartListItem = (cartItem) => {
  ...
  cartListItem.className = 'flex items-center justify-between py-2';

  const itemInfo = document.createElement('span');
  itemInfo.innerText = `${cartItem.name} x ${cartItem.quantity}`;

  const controls = document.createElement('div');
  const increaseBtn = getIncreaseQuantityBtn(cartItem);
  const decreaseBtn = getDecreaseQuantityBtn(cartItem);
  const removeBtn = getRemoveFromCartBtn(cartItem);

  controls.append(decreaseBtn, increaseBtn, removeBtn);
  cartListItem.append(itemInfo, controls);
