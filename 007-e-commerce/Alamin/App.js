const products = [
  ...
  },
  {
    ...
    price: 100,
    image: "Assets/Image/product8.png",
    categories: ["Accessories", "Peripherals"],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    name: "Graphics Card",
    price: 500,
    image: "Assets/Image/product4.avif",
  ...
  },
  {
    ...
    name: "Gaming Monitor",
    price: 300,
    image: "Assets/Image/product6.avif",
  ...
  },
  {
    ...
    price: 150,
    image: "Assets/Image/product7.png",
...
const getRemoveFromCartBtn = (cartItem) => {
  ...
  removeFromCartBtn.className = "text-red-500 ml-2 hover:bg-blue-300 p-2 ";
...
const getCartListItem = (cartItem) => {
  ...
  incrementButton.className =
    "font-bold bg-red-500 hover:bg-blue-500 text-white m-2 px-4 rounded-md";
  ...
  decrementButton.className =
    "font-bold bg-red-500 hover:bg-green-500 text-white px-4 rounded-md";
  ...
  cartListItem.appendChild(incrementButton);
  cartListItem.appendChild(decrementButton);
